...
(function($){ 	
	...
	var createGrips = function(t){	
		...
		// Check for RTL directionality in the createGrips function
		if (t.opt.rtl) {
			th = th.get().reverse();				// Reverse the order of columns if RTL is enabled
		}
	...
	*/
	...
	var onGripDrag = function(e){	
		...
		var mw = t.opt.minWidth;				//cell's min width
		var i = drag.i;
